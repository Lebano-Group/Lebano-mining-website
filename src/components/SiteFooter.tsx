    ...
    <footer className="mt-24 border-t border-border bg-gradient-panel">
      <div className="container-narrow py-16 grid gap-12 md:grid-cols-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            A decade of excellence in coal mining, exploration, and end-to-end bulk commodity logistics across South Africa.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li className="flex gap-2"><MapPin className="size-4 mt-0.5 text-primary shrink-0" /> Building 11, 94 Bekker Road, Vorna Valley, Midrand</li>
            <li className="flex gap-2"><Phone className="size-4 mt-0.5 text-primary shrink-0" /> +27 10 824 8330</li>
            <li className="flex gap-2"><Mail className="size-4 mt-0.5 text-primary shrink-0" /> info@lebanomining.com</li>
            <li className="flex gap-2"><Clock className="size-4 mt-0.5 text-primary shrink-0" /> Mon – Fri, 08:00 – 16:00</li>
          </ul>
        </div>
        <div>
      ...
      <div className="border-t border-border/60">
        <div className="container-narrow py-6 text-xs text-muted-foreground flex flex-col md:flex-row justify-between gap-2">
          <span>© {new Date().getFullYear()} Lebano Mining (Pty) Ltd. All rights reserved.</span>
