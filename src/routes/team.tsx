...
const members = [
  ...
  },
  {
    ...
    facts: [
      "Commerce & Law (cum Laude), UCT",
      "25 yrs international M&A",
      "NYSE · TSX · JSE listed boards",
    ],
    bio: [
  ...
  },
  {
    ...
    facts: [
      ...
      "PwC South Africa & USA assurance",
      "Former CFO, Atlatsa Resources",
    ],
    bio: [
  ...
  return (
    <>
      <PageHeader
        title={
          <>
            The people behind <span className="text-gradient-gold">Lebano Mining</span>.
          </>
        }
        subtitle="A leadership team combining deep operational mining experience with international corporate finance and governance."
        image={teamSite}
      />
          ...
          >
            <div className="lg:col-span-5 relative">
              ...
              <img
                src={m.img}
                alt={m.name}
                className="relative rounded shadow-elevated w-full aspect-[4/5] object-cover object-top bg-card"
              />
            </div>
            <div className="lg:col-span-7">
              ...
              <ul className="flex flex-wrap gap-2 mb-6">
                {m.facts.map((f) => (
                  <li
                    key={f}
                    className="text-xs uppercase tracking-wider px-3 py-1.5 rounded-full border border-border bg-card text-muted-foreground"
                  >
                    {f}
                  </li>
                ))}
