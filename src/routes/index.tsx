      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="relative container-narrow py-32 md:py-44">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/40 bg-primary/10 text-primary text-xs uppercase tracking-[0.25em] mb-8 transition-transform duration-300 hover:scale-[1.02]">
            <span className="size-1.5 rounded-full bg-primary animate-pulse" /> Est. 2012 · South
            Africa
          </div>
          <HeroMarqueeHeadline />
      ...
      <section className="container-narrow py-24 grid lg:grid-cols-2 gap-12 items-center">
        <div className={`p-8 md:p-10 ${cardHover}`}>
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            As a bulk commodity logistics partner with operations through Richards Bay, Lebano
            Mining has consistently delivered excellent services, contributing significantly to the
            energy landscape.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            We continuously invest in research and development, exploring new technologies and
            methodologies to enhance efficiency, reduce environmental impact, and meet the evolving
            demands of our clients and stakeholders.
          </p>
        </div>
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="relative container-narrow py-24 text-center">
          <h2 className="font-display text-4xl md:text-6xl uppercase max-w-3xl mx-auto transition-transform duration-500 hover:scale-[1.02]">
            Explore a world of <span className="text-gradient-gold">possibilities</span> with a
            trusted leader.
          </h2>
          <Link
            to="/contact"
