...
const usProjectsHeadline =
  "As part of our global expansion strategy, Lebano Mining and its international partners have gold development projects in the United States.";

const usProjects = [
  {
    code: "PROJECT 01 — NEVADA",
    meta: "Portfolio Value: USD 7.7 Billion",
  },
  {
    code: "PROJECT 02 — ARIZONA",
    meta: "Portfolio Value: USD 3.2 Billion",
    
  },
  {
    code: "PROJECT 03 — SOUTH ARIZONA",
    meta: "Portfolio Value: USD 2 Billion",
  },
  {
    code: "PROJECT 04 — CONNECTICUT",
    meta: "Portfolio Value: USD 2.1 Billion",
  },
] as const;
      ...
      <section className="border-t border-border bg-background">
        <div className="container-narrow py-24 md:py-28">
          <div className="max-w-4xl mb-10">
            <h2 className="font-display text-lg leading-snug text-gradient-gold md:text-xl">
              {usProjectsHeadline}
            </h2>
          </div>
