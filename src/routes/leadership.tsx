...
const leaders: readonly Leader[] = [
  {
    ...
    bio: [
      ...
      "Prior to founding Lebano Mining, Mr. Mutavhatsindi participated in mining activities in the DRC, Lubumbashi, Katanga and Tshikapa between 2006 to 2009. In partnership with Village Main Reef, he acquired the Buffelsfontein Gold Mine in Klerksdorp (Orkney) and led a successful turnaround of old Harmony Gold Mine assets between 2010 and 2016 returning a financially distressed operation to profitability.",
